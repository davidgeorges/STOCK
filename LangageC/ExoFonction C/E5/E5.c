...
void choixSaisie(int *);/* Saisie nombre carte ou polaire */
void choixOperateur(double,double,double,double,int);/* Choix operateur et appel fonction selon saisie */
void additionCartesienne(double,double,double,double,int);/* Addition a partir de la forme cartesienne */
void soustractionCartesienne(double,double,double,double,int);/* Soustracion a partir de la forme cartesienne */
void multiplierPolaire(double,double,double,double,int);/* Multiplier a partir de la forme polaire */
...
void choixOperateur(double x1,double  y1,double  x2,double  y2,int val){
    ...
    {
    case '+':
        additionCartesienne(x1,y1,x2,y2,val);
        break;
    
    case '-':
        soustractionCartesienne(x1,y1,x2,y2,val);
        break;

    case '*':
        multiplierPolaire(x1,y1,x2,y2,val);
        break;

    case '/':
        divisionPolaire(x1,y1,x2,y2,val);
        break;
...
void additionCartesienne(double x1,double  y1,double  x2,double  y2,int val){
...
void soustractionCartesienne(double x1,double  y1,double  x2,double  y2,int val){
...
void multiplierPolaire(double x1,double  y1,double  x2,double  y2,int val){
...
void divisionPolaire(double x1,double  y1,double  x2,double  y2,int val){
